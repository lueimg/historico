            ...
            <script type="text/javascript">
                ...
                function cargarCedula() {
                    ...
                    if ($('#empresa').val() == '') {
                        ...
                        var parametros = {cargarCedula: "cargarCedula", idempresa: $("#empresa").val(),quiebre: "<?php echo $quiebre; ?>"}
                        $.ajax({
                            type: "POST",
                            url: "controladorHistorico/historicoController.php",
                            data: parametros,
                ...
                <div class="datos">
                    ...
                    <div class="content_datos">
                        <div class="caja_medium">
                            <label>Empresa:</label>
                            <select class="empresa" id="empresa" name="empresa" onchange="cargarCedula();">
